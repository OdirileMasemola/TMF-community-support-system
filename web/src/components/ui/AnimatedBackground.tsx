  ...
  return (
    ...
    >
      ...
      <div className="animated-blobs absolute inset-0">
        <div
          className={`${reduceMotion ? "" : "animate-first "}absolute left-[10%] top-[5%] h-[32rem] w-[32rem] rounded-full blur-2xl`}
          style={blobStyle("--animated-first-color")}
        />
        <div
          className={`${reduceMotion ? "" : "animate-second "}absolute right-[5%] top-[15%] h-[28rem] w-[28rem] rounded-full blur-2xl`}
